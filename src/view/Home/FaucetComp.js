...
const FaucetComp = ({ onModalViewClick }) => {
    ...
    return (      
         ...
         <div data-speed="1.1" className="gallery__right _right">
 ...
 <img className="gallery__item _item faucet_img" src="img/work/4.png" alt="Alt" />

 <img className="gallery__item _item faucet_mob" src="img/work/2.png" alt="Alt" />
