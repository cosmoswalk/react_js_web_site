...
const ModalView_m = ({ isOpen, onClose }) => {
    ...
    return isOpen ? (
            ...
            <div className="modal-window-mob" onClick={onClose}>
                <div className="modal-content-window-mob" onClick={handleContentClick}>
                    <span className="close-window" onClick={onClose}>&times;</span>
                    <div className="modal-body-window-mob">
                        {/* <img src={logo_about} alt="About" className="modal-image" onLoad={handleImageLoad} /> */}
                        <p className='text-window-mob'>  
...
In summary, our Faucet provides a user-friendly experience while prioritizing security and protection against potential threats.
                    ...
                    <div className="mini-images-mob" style={{justifyContent: 'center', textAlign: 'center'}} >
               <a href="https://archway.faucet.stake-take.com/" target='_blank'><img className="mini-images__item_mob" src={images.arch_faucet} alt="Alt" style={{width: 80, height: 18 , borderRadius:' 8px',  marginTop: '6px'}} /></a>  
               <a href="https://humans.faucet.stake-take.com/" target='_blank'><img className="mini-images__item_mob" src={images.humans_faucet} alt="Alt" style={{width: 80, height: 18 ,marginLeft: '30px', borderRadius:' 8px'}} /></a>  
               <a href="https://umee.faucet.stake-take.com/" target='_blank'> <img className="mini-images__item_mob" src={images.umee_faucet} alt="Alt" style={{width: 80, height: 18, borderRadius:' 8px', marginTop: '6px' }} /></a> 
             
               <a href="https://quicksilver.faucet.stake-take.com/" target='_blank'><img className="mini-images__item_mob" src={images.quicksilver_faucet} alt="Alt" style={{width: 80, height: 18 ,marginLeft: '30px', borderRadius:' 8px' }} /></a> 
            </div>
                </div>
            </div>
